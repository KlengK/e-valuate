        ...
        <div class="py-12">
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <h3 class="text-lg font-medium text-gray-900">Shareable Link</h3>
                    <p class="mt-1 text-sm text-gray-600">Copy this link and share it directly.</p>
                    <div class="mt-4 flex items-center space-x-2">
                        <input
                            id="shareUrlInput"
                            :value="shareUrl"
                            type="text"
                            class="block w-full bg-gray-100 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                            readonly
                        />
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Download this QR code to use on posters and flyers.</p>
                    
                    <div class="relative inline-block mt-4 p-4 border rounded-lg">
                ...
                <div class="text-center">
                     <Link :href="route('surveys.index')" class="text-sm text-indigo-600 hover:text-indigo-800">
